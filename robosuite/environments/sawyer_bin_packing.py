...
class SawyerBinPacking(SawyerEnv):
    def __init__(
        self,
...
class SawyerPickPlaceSingle(SawyerBinPacking):
    """
...
class SawyerPickPlaceMilk(SawyerBinPacking):
    """
...
class SawyerPickPlaceBread(SawyerBinPacking):
    """
...
class SawyerPickPlaceCereal(SawyerBinPacking):
    """
...
class SawyerPickPlaceCan(SawyerBinPacking):
    """
